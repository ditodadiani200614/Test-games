...
, QTabWidget, QTableWidgetItem, QHeaderView, QCheckBox, QDateEdit, QLineEdit , QTableWidget)
...
class FitTrack(QWidget):
    ...
    def initUI(self):
        ...
        self.description_box.setPlaceholderText("Enter description")
        ...
        self.sub_row4.addWidget(self.description_box)
    ...
    def delete_workout(self):
        ...
        if selected_row == -1:
            QMessageBox.warning(self,"Eror","Please select a row to delete")
            return
    ...
    def calculate_calories(self):
        ...
        try:
            ...
            print(f"ERROR:{e}")
            QMessageBox.warning(self,"Eror","Please enter some data first")
...
if not db.open():
    QMessageBox.critical(None, "Error", "Database Error")
    exit(2)
query=QSqlQuery()
query.exec_("""
